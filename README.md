...
|---|---:|---|
| [`drawio-skill`](publish-drawio-skill/) | `1.22.0-corporate.3` | Редактируемые draw.io-диаграммы с Supervisor/Reviewer/Repair/Semantic Analyst, roadmap, git-flow и архитектурными схемами |
