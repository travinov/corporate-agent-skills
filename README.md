...
|---|---:|---|
| [`drawio-skill`](publish-drawio-skill/) | `1.23.0-corporate.2` | Редактируемые draw.io-диаграммы с conversational multi-model create/improve/resume/trace циклом, roadmap, git-flow и архитектурными схемами |
