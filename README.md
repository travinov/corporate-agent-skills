...
|---|---:|---|
| [`drawio-skill`](publish-drawio-skill/) | `1.24.0-corporate.5` | Редактируемые draw.io-диаграммы с безопасным Qwen command-input bridge, автономным bounded multi-model repair loop, безопасной best-effort выдачей, строгим разделением working/publishable/final, потоковой трассировкой ролей, roadmap, git-flow и архитектурными схемами |
