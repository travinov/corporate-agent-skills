...
|---|---:|---|
| [`drawio-skill`](publish-drawio-skill/) | `1.24.0-corporate.2` | Редактируемые draw.io-диаграммы с безопасным Qwen command-input bridge, zero-argument review-to-improve handoff, изолированным multi-model create/improve/resume/trace циклом, потоковой трассировкой ролей, roadmap, git-flow и архитектурными схемами |
