...
""",
    ...
    def test_install_backs_up_legacy_skill_and_verifies(self) -> None:
        ...
        self.assertIn("Installed publish-drawio-skill 1.24.0-corporate.2", result.stdout)
    ...
    def test_verifier_accepts_canonical_markdown_command(self) -> None:
        ...
        self.assertIn("Verified publish-drawio-skill 1.24.0-corporate.2", verify.stdout)
    ...
    def test_verifier_uses_active_copy_when_current_source_is_missing(self) -> None:
        ...
        self.assertIn("Verified publish-drawio-skill 1.24.0-corporate.2", result.stdout)
