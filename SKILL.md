...
# WSL2: the CLI is the Windows desktop exe, reached via /mnt/c (note the space)
  ...
  echo "drawio not found — on Windows corporate laptops install draw.io Desktop from SberUserSoft: https://sberusersoft.sigma.sbrf.ru/#search/Draw.io ; on macOS use Homebrew: brew install --cask drawio"
fi
```
